                                        ...
                                        .then(() => {
                                            ...
                                            User
                                                ...
                                                .then(() => {
                                                    ...
                                                    const notificationOne = new Notification({ user_id: decoded.user._id, msg: `${req.body.quantity} credits transfer to ${user.username} was done successfuly`, time: Date.now() })
                                                    const notificationTwo = new Notification({ user_id: user._id, msg: `${req.body.quantity} credits were transfered from ${decoded.user.username} successfuly`, time: Date.now() })
                                                    //SAVE THE FIRST
                                                    notificationOne
                                                        .save()
                                                        .then((notification) => {
